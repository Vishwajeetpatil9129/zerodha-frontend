  ...
  return (
    <div className="container mt-5">
      <div className="row text-center">
        ...
        <div className="col-4 p-3 mt-5">
          <img src="media\images\sensibullLogo.svg" style={{ width: "60%" }} className="mb-3"/>
...
data points like open interest, FII/DII, and more.
        ...
        <div className="col-4 p-3 mt-5">
          <img src="media\images\streakLogo.png" style={{ width: "50%" }} className="mb-3"/>
...
baskets of stocks on ETFs.</p>
        ...
        <div className="col-4 p-3 mt-5">
          <img src="media\images\dittoLogo.png" style={{ width: "40%" }} className="mb-3"/>
